      ...
      <div className="cookies-container">
        <div className="cookies-item">
          ...
          <p>
            ...
            visitez de nouveau plus tard. Certains de ces cookies sont
            nécessaires pour accéder à certaines fonctionnalités d’un site.
            D’autres cookies sont d’utilité pratique pour le visiteur : ils
            sauvegardent de manière sécurisée votre nom d’utilisateur ou vos
            préférences linguistiques par exemple. Les cookies signifient tout
            simplement qu’à chaque fois que vous visitez un site web, vous
            n’avez pas besoin de saisir à nouveau les mêmes informations.
          </p>
        </div>
        ...
        <div className="cookies-item">
          ...
          <p>
            ...
            optimiser la performance du site. Xmass Clicker a pris toutes
        ...
        <div className="cookies-item">
          ...
          <p>
            ...
            cookies. Notez toutefois que si vous désactivez les cookies, votre
            nom d’utilisateur ainsi que votre mot de passe ne seront plus
            sauvegardés sur aucun site web.
          </p>
        </div>
        ...
        <div className="cookies-item">
          ...
          <p>
            ...
            cliquez sur « utiliser les paramètres personnalisés pour
            l’historique » <br />
